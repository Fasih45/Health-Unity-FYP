                ...
                <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4 h-full">
                    <div class="col-span-4 sm:col-span-3">
                        <div class="bg-white shadow rounded-lg p-6 h-full">
                            ...
                            <div class="flex flex-col">
                                <span class="text-gray-700 uppercase font-bold tracking-wider mb-2">Specialization</span>
                                <ul>
                                    <li class="mb-2">{user.speciality}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-span-4 sm:col-span-9">
                        <div class="bg-white shadow rounded-lg p-6">
                            ...
                            <p class="text-gray-700 text-justify ">{user.bio}</p>
                            <h2 class="text-xl font-bold mb-4 mt-4">Description</h2>
                            <p class="text-gray-700 text-justify ">{user.des}</p>
