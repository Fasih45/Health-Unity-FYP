...
import { rate } from "../redux/actions/docProfile";
            ...
            {user === "patient" && (
              <td className="px-4 py-4 text-sm whitespace-nowrap">
                <div className="flex items-center gap-x-6">
                  ...
                  {appointment.status === "Settled" && !appointment.rate ? (
                    <button
                      ...
                      onClick={() => {
                        setshowRating(true);
                        setId({ id: appointment._id, index: index });
                      }}
                    >
                      Give Rating
                    </button>
        ...
        >
          <div className="bg-white p-5 w-20em pt-2 rounded ">
            ...
            <div className="flex justify-center mt-6 m-5">
              <>
                <fieldset class="rate">
                  ...
                  />
                  <label class="half" for="rating5" title=" 2.5stars"></label>
                  <input
                    type="radio"
                    id="rating4"
                    name="rating"
            ...
            <div className="flex justify-between">
              <button
                onClick={() => {
                  console.log("userRating", Rating, aID);
                  dispatch(rate(aID.id, Rating));
                  setRating(0);
                  setshowRating(false);
                  appointments[aID.index].rate=true;
                }}
